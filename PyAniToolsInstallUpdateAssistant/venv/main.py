...
Making Executable - Pyinstaller
     ...
     cd C:\Users\Patrick\PycharmProjects\PyAniTools\PyAniToolsInstallUpdateAssistant\venv\
     pyinstaller --onefile --console --icon=Resources\setup.ico --name PyAniToolsIUAssist main.py
...
import os
import logging
from pyani.core.toolsinstallassist import AniToolsIUAssist
...
def main():
    ...
    window = AniToolsIUAssist(error_logging, parameters)
